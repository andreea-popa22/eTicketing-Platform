...
public class EventService {
    ...
    public static Concert addConcert(Organizer org) {
        ...
        try {
            objects = ReadFromCSV.readFromCSV("singer", "./src/resources/singers.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
            ...
            if (choice == 1) {
                ...
                while (true) {
                    ...
                    if (choice == 1) {
                        ...
                        try {
                            WriteToCSV.writeToCSV(event_location, "./src/resources/arenas.csv");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                        ...
                        try {
                            WriteToCSV.writeToCSV(event_location, "./src/resources/outdoors.csv");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                        ...
                        try {
                            WriteToCSV.writeToCSV(event_location, "./src/resources/theatres.csv");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
    ...
    public static Play addPlay(Organizer org) {
        ...
        try {
            objects = ReadFromCSV.readFromCSV("actor", "./src/resources/actors.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
        for (int i = 0; i < objects.size(); i++) {
